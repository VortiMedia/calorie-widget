...
function generateStandardEmbedCode(settings) {
    ...
    // Add text settings
    code += `        title: '${settings.title}',\n`;
    code += `        subtitle: '${settings.subtitle}',\n`;
    code += `        footerText: '${settings.footerText}',\n`;
    ...
    if (settings.requireLeadCapture) {
        ...
        code += `        leadFormTitle: '${settings.leadFormTitle}',\n`;
        code += `        leadFormDescription: '${settings.leadFormDescription}',\n`;
        code += `        leadFormButtonText: '${settings.leadFormButton}',\n`;
        code += `        leadFormPrivacyText: '${settings.leadFormPrivacy}',\n`;
    }
    ...
    if (settings.requireLeadCapture) {
        ...
        if (settings.integration !== 'none') {
            ...
            if (settings.integration === 'webhook') {
                code += `          fetch('${settings.integrationApiKey}', {\n`;
                code += `            method: 'POST',\n`;
...
function generateOneLineEmbedCode(settings) {
    ...
    code += `  data-title="${settings.title}"\n`;
    code += `  data-subtitle="${settings.subtitle}"\n`;
    code += `  data-footer-text="${settings.footerText}"\n`;
    code += `  data-max-width="${settings.maxWidth}"\n`;
    code += `  data-require-lead-capture="${settings.requireLeadCapture}"\n`;
    
    if (settings.requireLeadCapture) {
        code += `  data-lead-form-title="${settings.leadFormTitle}"\n`;
        code += `  data-lead-form-description="${settings.leadFormDescription}"\n`;
        code += `  data-lead-form-button="${settings.leadFormButton}"\n`;
    }
...
function generateIframeEmbedCode(settings) {
    ...
    if (settings.logo) {
        queryParams.append('logoUrl', encodeURIComponent(settings.logo));
    }
